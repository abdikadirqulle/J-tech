...
const Contact = () => {
  return (
    <div >
      <div id='contact'  className="bg-white dark:bg-blue-950 self-stretch flex w-full flex-col items-center  px-5 py-12 max-md:max-w-full">
            ...
            <div  className="flex flex-col  p-2 items-stretch w-6/12 max-md:w-full max-md:ml-0">
              <div className="items-stretch flex grow flex-col max-md:max-w-full max-md:mt-10">
                <div className="text-blue-600 text-6xl leading-[63px] whitespace-nowrap max-md:max-w-full max-md:text-4xl max-md:leading-[51px]">
                  ...
                  <span className="text-blue-600 font-bold">Touch</span>
                </div>
                ...
                <textarea
                  ...
                  placeholder="Messege"
                />
                <button className="text-white dark:bg-blue-400 rounded-md text-base text-center font-bold  uppercase bg-secondary mt-5 px-5 py-4 max-md:max-w-full">
                  Let’s talk
                </button>
